...
e.CURRENT_TAG = e.VOLATILE_TAG = e.CONSTANT_TAG = e.update = e.dirty = e.MonomorphicTagImpl = e.COMPUTE = e.VOLATILE = e.INITIAL = e.CONSTANT = e.IteratorSynchronizer = e.ReferenceIterator = e.IterationArtifacts = e.ListItem = e.ConstReference = e.ReferenceCache = e.CachedReference = void 0;
const r =
...
class c {
  ...
  static update(e, t) {
    let r = e;
    if (t === p) r.subtag = null;
    else {
      r.subtag = t;
      r.lastChecked = Math.min(r.lastChecked, t.lastChecked);
      r.lastValue = Math.max(r.lastValue, t.lastValue);
    }
  }
  static dirty(e) {
    e.revision = ++s;
...
this.lastRevision=a()}return r}invalidate(){this.lastRevision=null}}e.CachedReference=b
